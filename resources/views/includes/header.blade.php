         ...
         <div class="navbar-collapse">
             ...
             <ul class="navbar-nav mr-auto mt-md-0">
                 ...
                 <li class="nav-item dropdown mega-dropdown">
                     <a
                         ...
                         aria-haspopup="true"
                         aria-expanded="false"><i class="mdi mdi-view-grid"></i></a>
             ...
             <ul class="navbar-nav my-lg-0">
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <div
                         class="dropdown-menu dropdown-menu-right mailbox scale-up">
                         <ul>
                             <li>
                                 ...
                                 <div class="message-center">
                                     ...
                                     <a href="#">
                                         ...
                                         <div class="mail-contnet">
                                             <h5>Luanch Admin</h5>
                                             <span class="mail-desc">Just see the my new
                                                 admin!</span>
                                     ...
                                     <a href="#">
                                         ...
                                         <div class="mail-contnet">
                                             <h5>Settings</h5>
                                             <span class="mail-desc">You can customize
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <div
                         class="dropdown-menu mailbox dropdown-menu-right scale-up"
                         aria-labelledby="2">
                         <ul>
                             <li>
                                 <div class="drop-title">
                 ...
                 <li class="nav-item dropdown">
                     <a
                         ...
                         aria-expanded="false"><img
                             ...
                             class="profile-pic" /></a>
                     <div
                         class="dropdown-menu dropdown-menu-right scale-up">
                         <ul class="dropdown-user">
                             ...
                             <li
                                 ...
                                 class="divider"></li>
                             <li>
                                 <a href="#"><i class="ti-user"></i> My
                                     Profile</a>
                             </li>
                             <li>
                                 <a href="#"><i class="ti-wallet"></i> My
                                     Balance</a>
                             </li>
                             <li>
                                 <a href="#"><i class="ti-email"></i>
                                     Inbox</a>
                             </li>
                             <li
                                 role="separator"
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <div
                         class="dropdown-menu dropdown-menu-right scale-up">
                         <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-in"></i>
                             India</a>
